...
#----Input authorization-----
auth = 'authorization:Bearer 20736|0MEJAwislxVQny1YV0Mh07cxZiOxWzfHSGjy4Pj8'
...
while True:
  ...
  while message != "Task Completed":
    ...
    headers2 = {"Host": "info.tmswp.com", "accept": "application/json, text/plain, */*", "authorization": "Bearer 20736|0MEJAwislxVQny1YV0Mh07cxZiOxWzfHSGjy4Pj8", "accept-encoding": "gzip", "user-agent": "okhttp/3.12.12"}
